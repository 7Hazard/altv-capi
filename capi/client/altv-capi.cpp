...
{
    return (struct alt_CClientScriptEvent*)new alt::CClientScriptEvent(*(class alt::StringView*)_name, *(class alt::MValueList*)_args);
}
...
{
    return (struct alt_CWebViewEvent*)new alt::CWebViewEvent((CWebView *)_target, *(class alt::StringView*)_name, *(class alt::MValueList*)_args);
}
