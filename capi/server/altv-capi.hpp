...
CAPI struct alt_CClientScriptEvent* alt_CClientScriptEvent_Create(struct alt_IPlayer* _target, struct alt_StringView* _name, struct alt_MValueList* _args);
...
// Pointer type
// cpptype class alt::IEntity
CAPI struct alt_IBlip* alt_IServer_CreateBlip_1(struct alt_IServer* _instance, struct alt_IPlayer* target, enum alt_IBlip_Type type, struct alt_IEntity* attachTo);
