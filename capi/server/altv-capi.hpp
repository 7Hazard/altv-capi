...
enum alt_CEvent_Type {
    ...
    ALT_CEVENT_TYPE_FIRE_EVENT = 9,
    ALT_CEVENT_TYPE_EXPLOSION_EVENT = 10,
    ALT_CEVENT_TYPE_WEAPON_DAMAGE_EVENT = 11,
    ALT_CEVENT_TYPE_CHECKPOINT_EVENT = 12,
    ALT_CEVENT_TYPE_COLSHAPE_EVENT = 13,
    ALT_CEVENT_TYPE_PLAYER_ENTER_VEHICLE = 14,
    ALT_CEVENT_TYPE_PLAYER_LEAVE_VEHICLE = 15,
    ALT_CEVENT_TYPE_PLAYER_CHANGE_VEHICLE_SEAT = 16,
    ALT_CEVENT_TYPE_REMOVE_ENTITY_EVENT = 17,
    ALT_CEVENT_TYPE_DATA_NODE_RECEIVED_EVENT = 18,
    ALT_CEVENT_TYPE_CONSOLE_COMMAND_EVENT = 19,
    ALT_CEVENT_TYPE_CONNECTION_COMPLETE = 20,
    ALT_CEVENT_TYPE_DISCONNECT_EVENT = 21,
    ALT_CEVENT_TYPE_WEB_VIEW_EVENT = 22,
    ALT_CEVENT_TYPE_KEYBOARD_EVENT = 23,
    ALT_CEVENT_TYPE_GAME_ENTITY_CREATE = 24,
    ALT_CEVENT_TYPE_GAME_ENTITY_DESTROY = 25,
    ALT_CEVENT_TYPE_ALL = 26,
    ALT_CEVENT_TYPE_SIZE = 27
};
