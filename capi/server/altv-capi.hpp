...
#ifdef CAPI_DLL
#ifdef _WIN32
#define CAPI CAPI_EXTERN __declspec(dllimport)
#endif // _WIN32
#else
...
CAPI void alt_IColShape_free(struct alt_IColShape* ptr);
...
// Returns class alt::Vector<float, 3, class alt::PointLayout>
// Return ptr must be manually freed with alt_Vectorfloat3PointLayout_free()
CAPI struct alt_Vectorfloat3PointLayout* alt_IColShape_GetPosition(struct alt_IColShape* _instance);
...
CAPI enum alt_ColShapeType alt_IColShape_GetColshapeType(struct alt_IColShape* _instance);
...
CAPI void alt_IServer_free(struct alt_IServer* ptr);
...
CAPI void alt_IServer_SubscribeEvent(struct alt_IServer* _instance, enum alt_CEvent_Type ev, _Bool (*cb)(struct alt_CEvent*));
...
// Param class alt::Vector<float, 3, class alt::PointLayout> pos
CAPI struct alt_IBlip* alt_IServer_CreateBlip(struct alt_IServer* _instance, struct alt_IPlayer* target, enum alt_IBlip_Type type, struct alt_Vectorfloat3PointLayout* pos);
...
CAPI struct alt_IBlip* alt_IServer_CreateBlip1(struct alt_IServer* _instance, struct alt_IPlayer* target, enum alt_IBlip_Type type, struct alt_IEntity* attachTo);
...
// Param class alt::StringView name
// Return ptr must be manually freed with alt_ArrayIPlayerPtr_free()
CAPI struct alt_ArrayIPlayer** alt_IServer_GetPlayersByName(struct alt_IServer* _instance, struct alt_StringView* name);
...
// Return ptr must be manually freed with alt_ArrayIEntityPtr_free()
CAPI struct alt_ArrayIEntity** alt_IServer_GetEntities(struct alt_IServer* _instance);
...
// Returns class alt::Array<class alt::IPlayer *>
// Return ptr must be manually freed with alt_ArrayIPlayerPtr_free()
CAPI struct alt_ArrayIPlayer** alt_IServer_GetPlayers(struct alt_IServer* _instance);
...
// Return ptr must be manually freed with alt_ArrayIVehiclePtr_free()
CAPI struct alt_ArrayIVehicle** alt_IServer_GetVehicles(struct alt_IServer* _instance);
