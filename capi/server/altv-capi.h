...
typedef enum altIResourceState {
...
typedef enum altIBaseObjectType {
...
typedef enum altIPackageMode {
    ALTIPACKAGEMODE_READ = 0,
    ALTIPACKAGEMODE_WRITE = 1
};

typedef enum altIPackageSeekOrigin {
...
// class alt::IServer
typedef struct alt_IServer alt_IServer;
