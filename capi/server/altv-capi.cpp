...
{
    return (enum alt_ColShapeType)((alt::IColShape *)_instance)->GetColshapeType();
}
...
{
    const auto& addr = ((alt::IServer *)_instance)->GetRootDirectory();
    memcpy(_return, &addr, sizeof(class alt::StringView));
}
...
{
    return (struct alt_ArrayIPlayer**)(new class alt::Array<class alt::IPlayer *>(((alt::IServer *)_instance)->GetPlayersByName(*(class alt::StringView*)name)));
}

CAPI struct alt_ArrayIEntity** alt_IServer_GetEntities(struct alt_IServer* _instance)
{
    return (struct alt_ArrayIEntity**)(new class alt::Array<class alt::IEntity *>(((alt::IServer *)_instance)->GetEntities()));
}

CAPI struct alt_ArrayIPlayer** alt_IServer_GetPlayers(struct alt_IServer* _instance)
{
    return (struct alt_ArrayIPlayer**)(new class alt::Array<class alt::IPlayer *>(((alt::IServer *)_instance)->GetPlayers()));
}

CAPI struct alt_ArrayIVehicle** alt_IServer_GetVehicles(struct alt_IServer* _instance)
{
    return (struct alt_ArrayIVehicle**)(new class alt::Array<class alt::IVehicle *>(((alt::IServer *)_instance)->GetVehicles()));
}
