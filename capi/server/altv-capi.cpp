...
{
    return (alt_Vectorfloat3PointLayout*)new class alt::Vector<float, 3, class alt::PointLayout>(((alt::IWorldObject *)_instance)->GetPosition());
}
...
{
    return (alt_Vectorfloat3RotationLayout*)new class alt::Vector<float, 3, class alt::RotationLayout>(((alt::IEntity *)_instance)->GetRotation());
}
...
{
    return (alt_Arrayunsigned_int*)new class alt::Array<unsigned int>(((alt::IPlayer *)_instance)->GetCurrentWeaponComponents());
}
...
{
    return (alt_Vectorfloat3PointLayout*)new class alt::Vector<float, 3, class alt::PointLayout>(((alt::IPlayer *)_instance)->GetAimPos());
}

CAPI struct alt_Vectorfloat3RotationLayout* alt_IPlayer_GetHeadRotation(struct alt_IPlayer* _instance)
{
    return (alt_Vectorfloat3RotationLayout*)new class alt::Vector<float, 3, class alt::RotationLayout>(((alt::IPlayer *)_instance)->GetHeadRotation());
}
...
{
    return (alt_Vectorfloat3PointLayout*)new class alt::Vector<float, 3, class alt::PointLayout>(((alt::IPlayer *)_instance)->GetEntityAimOffset());
}
...
{
    return (alt_ArrayStringView*)&((alt::CConsoleCommandEvent *)_instance)->GetArgs();
}
...
{
    return (alt_ArrayIPlayer**)new class alt::Array<class alt::IPlayer *>(((alt::IServer *)_instance)->GetPlayersByName(*(class alt::StringView*)name));
}

CAPI struct alt_ArrayIEntity** alt_IServer_GetEntities(struct alt_IServer* _instance)
{
    return (alt_ArrayIEntity**)new class alt::Array<class alt::IEntity *>(((alt::IServer *)_instance)->GetEntities());
}

CAPI struct alt_ArrayIPlayer** alt_IServer_GetPlayers(struct alt_IServer* _instance)
{
    return (alt_ArrayIPlayer**)new class alt::Array<class alt::IPlayer *>(((alt::IServer *)_instance)->GetPlayers());
}

CAPI struct alt_ArrayIVehicle** alt_IServer_GetVehicles(struct alt_IServer* _instance)
{
    return (alt_ArrayIVehicle**)new class alt::Array<class alt::IVehicle *>(((alt::IServer *)_instance)->GetVehicles());
}
