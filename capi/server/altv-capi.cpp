...
{
    return (_Bool)((alt::IResource::Impl *)_instance)->MakeClient((struct alt::IResource::CreationInfo *)info, *(class alt::Array<class alt::String>*)files);
}
...
{
    ((alt::ICore *)_instance)->TriggerClientEvent((class alt::IPlayer *)target, *(class alt::StringView*)ev, *(class alt::MValueList*)args);
}
...
{
    return (alt_IVehicle*)((alt::ICore *)_instance)->CreateVehicle((unsigned int)model, *(class alt::Vector<float, 3, class alt::PointLayout>*)pos, *(class alt::Vector<float, 3, class alt::RotationLayout>*)rot);
}
...
{
    return (alt_ICheckpoint*)((alt::ICore *)_instance)->CreateCheckpoint((class alt::IPlayer *)target, (unsigned char)type, *(class alt::Vector<float, 3, class alt::PointLayout>*)pos, (float)radius, (float)height, *(struct alt::RGBA*)color);
}
...
{
    return (alt_IBlip*)((alt::ICore *)_instance)->CreateBlip((class alt::IPlayer *)target, (enum alt::IBlip::Type)type, *(class alt::Vector<float, 3, class alt::PointLayout>*)pos);
}
...
{
    return (alt_IBlip*)((alt::ICore *)_instance)->CreateBlip((class alt::IPlayer *)target, (enum alt::IBlip::Type)type, (class alt::IEntity *)attachTo);
}
...
{
    return (alt_IEntity*)((alt::ICore *)_instance)->GetEntityByID((unsigned short)id);
}

CAPI void alt_ICore_DestroyBaseObject(struct alt_ICore* _instance, struct alt_IBaseObject* handle)
{
    ((alt::ICore *)_instance)->DestroyBaseObject((class alt::IBaseObject *)handle);
}
